...
const unitData = {
    ...
    "Zaman": ["Saniye", "Dakika", "Saat", "Gün", "Hafta", "Yıl (Takvim)"],
...
// Katsayılar (Temel birimlere göre: Uzunluk->Metre, Zaman->Saniye, Kütle->Kg)
...
function performConversion() {
    ...
    if (mode === "Alfabe") {
        if (currentInputUnit === "Eski Alfabe") {
...
// --- ÖZEL ZAMAN FONKSİYONLARI (HEADER İÇİN) ---
