...
// Alfabe Tanımlamaları - İndeks bazlı tam eşleşme
const alphabetMaps = {
    "Standart": [
    ...
    "Yeni Alfabe": [
        "Α", "Β", "J", "C", "D", "Ε", "F", "G", "Γ", "Η", "Ь", "Ͱ", "Σ", "Κ", "L", "Μ", "Ν", "Q", "Ω", "Π", "Ρ", "S", "Ш", "Τ", "U", "Y", "V", "Ψ", "R", "Ζ",
        "Α", "Β", "J", "C", "D", "Ε", "F", "G", "Γ", "Η", "Ь", "Ͱ", "Σ", "Κ", "L", "Μ", "Ν", "Q", "Ω", "Π", "Ρ", "S", "Ш", "Τ", "U", "Y", "V", "Ψ", "R", "Ζ",
        "θ"
    ]
};
...
// Input Dinleyicileri
latin.addEventListener('input', () => { activeInput = latin; performTranslation(); });
greek.addEventListener('input', () => { activeInput = greek; performTranslation(); });
