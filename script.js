...
function renderHistory() {
    ...
    searchHistory.forEach(item => {
        ...
        d.innerHTML = `<div class="font-bold text-foreground-light dark:text-foreground-dark opacity-80">${isGreek ? convertToGreek(item.clickedText) : item.clickedText}</div>`;
